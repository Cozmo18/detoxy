...
HELLO_MESSAGE = "👋 Welcome @{author}! We're excited to have you join our positive community. Feel free to introduce yourself!"
WELCOME_BACK = "Welcome back @{author}! Great to see you again in our community."
USER_LEAVE = "Take care @{author}! We hope to see you again soon."
...
TOXIC_CHANNEL_ALERT = "⚠️ A message has been flagged as potentially harmful. Our moderators will review it shortly."
...
ERROR_MESSAGE = "❌ Oops! Something went wrong. Our team has been notified and will fix it soon."
...
REPORT_CONFIRMATION = "✅ Thank you for your report. Our moderation team will review it promptly."
